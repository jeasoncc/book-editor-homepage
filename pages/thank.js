...
const VersionComponent = ({duration}) => {
  ...
  <div className="container px-5 py-24 mx-auto">
    <div className="flex flex-col text-center w-full mb-20">
      <h1 className="sm:text-3xl text-2xl font-medium title-font mb-4 text-gray-900">感谢</h1>
      <p className="lg:w-2/3 mx-auto leading-relaxed text-base">小密圈码字的开发，离不开我的作者朋友提供的反馈和支持，感谢各位为小密圈码字提供的宝贵建议。</p>
    </div>
